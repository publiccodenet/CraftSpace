<script>
  ...
  function handleCreate() {
    goto(`/admin/collections/create?id=${collection_id}`);
  }
...
<div class="collection-page">
  ...
  {:else}
    ...
    <header>
      <div class="header-content">
        ...
        <div class="header-actions">
          <a href={`/admin/collections/${collection_id}/edit`} class="secondary-button">Edit</a>
          <a href={`/admin/collections/${collection_id}/items`} class="primary-button">View Items</a>
        </div>
      </div>
    </header>
    ...
    <div class="actions">
      <a href={`/admin/collections/${collection_id}/items`} class="primary-button">Browse Items</a>
      <a href={`/admin/collections/${collection_id}/fetch`} class="secondary-button">Fetch New Items</a>
    </div>
  {/if}
</div>
