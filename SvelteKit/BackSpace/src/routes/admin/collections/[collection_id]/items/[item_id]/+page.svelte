<script>
  ...
  const collection_id = $page.params.collection_id;
  const item_id = $page.params.item_id;
  ...
  onMount(async () => {
    try {
      ...
      const collectionResponse = await fetch(`/api/collections/${collection_id}`);
      ...
      if (collection.itemsArray) {
        foundItem = collection.itemsArray.find(i => i.id === item_id);
      } else if (collection.items && typeof collection.items === 'object') {
        foundItem = collection.items[item_id];
        if (foundItem) {
...
<div class="item-page">
  ...
  {:else if collectionNotFound}
    <div class="not-found">
      ...
      <p>The collection with ID "{collection_id}" does not exist.</p>
  ...
  {:else if notFound}
    <div class="not-found">
      ...
      <p>The item with ID "{item_id}" does not exist in this collection.</p>
      <div class="action-buttons">
        <a href={`/admin/collections/${collection_id}/items`} class="secondary-button">Back to Items</a>
        <a href={`/admin/collections/${collection_id}/items/create?id=${item_id}`} class="primary-button">Create Item</a>
      </div>
    </div>
  {:else if error}
  ...
  {:else}
    <div class="breadcrumbs">
      ...
      <a href={`/admin/collections/${collection_id}`}>{collection.name}</a> / 
      <a href={`/admin/collections/${collection_id}/items`}>Items</a> /
    ...
    <header>
      <div class="header-content">
        ...
        <div class="header-actions">
          <a href={`/admin/collections/${collection_id}/items/${item_id}/edit`} class="secondary-button">Edit</a>
          <a href={`/admin/collections/${collection_id}/items/${item_id}/download`} class="primary-button">Download</a>
        </div>
      </div>
    </header>
                  ...
                  {#each item.files as file}
                    <tr>
                      ...
                      <td class="col-actions">
                        {#if file.downloaded}
                          <a href={`/api/files/${collection_id}/${item_id}/${file.name}`} class="action-button download" download>Download</a>
                        {:else}
