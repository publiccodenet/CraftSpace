  ...
  {:else}
    ...
    <header>
      <div class="header-content">
        ...
        <div class="header-actions">
          <a href={`/admin/collections/${collection_id}/items/create`} class="primary-button">Add Item</a>
          <a href={`/admin/collections/${collection_id}/fetch`} class="secondary-button">Fetch Items</a>
        </div>
      </div>
    </header>
    ...
    {:else}
      <div class="items-grid">
        {#each items as item}
          <a href={`/admin/collections/${collection_id}/items/${item.id}`} class="item-card">
