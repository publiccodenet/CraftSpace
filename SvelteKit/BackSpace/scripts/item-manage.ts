...
import { contentManager } from '../src/lib/content/index.js.js';
import chalk from 'chalk.js';
import { NotFoundError } from '../src/lib/errors/errors.js.js';
import { createLogger } from '../src/lib/utils/logger.js.js';
...
program
  ...
  .action(async (options) => {
    ...
    try {
      ...
      console.log(`Collection: ${item.collection_id}`);
      console.log(`Creator: ${item.creator || 'Unknown'}`);
      console.log(`Date: ${item.date || 'Unknown'}`);
